            ...
            <div class="col-xl-12 col-lg-6 mb-4">
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Admin Users Data</h6>
                  <a class="m-0 float-right btn btn-danger btn-sm" onclick="AddUserTypeData()" href="#">Add User <i class="fas fa-plus-circle"></i></a>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
					  ...
					  <tr>
                        <th> 
                            @if($user->admins_id== 26)
							<img src="{{URL::to($user->image)}}" class="img-fluid" alt="{{ $user->name }}" width="60">
                            @else
                            @endif
						</th>
                        <th>{{ $user->admins_id }}</th>
                        <th>{{ $user->name }}</th>
                        <th>{{ $user->phone }}</th>
                        <th>{{ $user->email }}</th>
                        <th> 
							@if($user->admins_status=="A")
								<span class="badge badge-success">Active</span>
							@elseif($user->admins_status=="N")
                        ...
                        <th> 
						<button onclick="showSlidereData({{$user->admins_id}})" class="btn btn-sm btn-primary">View</button>
						<button onclick="deleteUserData({{$user->admins_id}})" class="btn btn-sm btn-danger">Delete</button>
						</th>
                      </tr>
					  @endforeach
                    </tbody>
